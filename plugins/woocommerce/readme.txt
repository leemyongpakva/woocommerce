...
* Fix - Fix a bug where woocommerce removes the current-menu-item class.  #### Comment <!-- If the changes in this pull request don't warrant a changelog entry, you can alternatively supply a comment here. Note that comments are only accepted with a significance of "Patch" --> [#45095](https://github.com/woocommerce/woocommerce/pull/45095)
...
* Update - Add option to show order price in the "Place order" button. [#49252](https://github.com/woocommerce/woocommerce/pull/49252)
...
* Update - Update Settings to disable Save button unless modifications are made.  #### Comment <!-- If the changes in this pull request don't warrant a changelog entry, you can alternatively supply a comment here. Note that comments are only accepted with a significance of "Patch" --> [#47444](https://github.com/woocommerce/woocommerce/pull/47444)
...
* Tweak - Rename Google Listings and Ads with Google for WooCommerce #### Comment <!-- If the changes in this pull request don't warrant a changelog entry, you can alternatively supply a comment here. Note that comments are only accepted with a significance of "Patch" --> [#47614](https://github.com/woocommerce/woocommerce/pull/47614)
